...
def test_leg_servo():
    ...
    hardware_interface.set_actuator_position0(desired_angle, leg_index, motor_index)
...
def test_leg_params():
    ...
    while True:
        ...
        hardware_interface.set_actuator_position0(min_angle, leg_index, motor_index)
    ...
    while True:
        ...
        hardware_interface.set_actuator_position0(max_angle, leg_index, motor_index)

...
[![Watch the Dog in Action](https://img.youtube.com/vi/YOUR_VIDEO_ID/maxresdefault.jpg)](https://youtu.be/YOUR_VIDEO_ID)
...
* **Kinematics:** Forward and Inverse Kinematics engines calculated entirely in Python (`Kinematics.py`). Optimal leg dimensions were mapped using a genetic algorithm.
